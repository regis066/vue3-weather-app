...
<template>
  <main class="container text-white">
    <div class="pt-4 mb-8 relative">
      ...
      <ul class="absolute bg-weather-secondary text-white w-full shadow-md  py-1 top-[66px]" v-if="mapboxSearchResults">
        <li v-for="searchResult in mapboxSearchResults" :key="searchResult.id" class="py-2 cursor-pointer pl-3">
